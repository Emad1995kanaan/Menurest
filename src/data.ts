...
export const menuData: MenuCategory[] = [
  {
    ...
    items: [
      { id: "h1", name: "قهوة تركية", description: "قهوة تركية غنية ومحضرة على الأصول", price: 15 },
  ...
  },
  {
    ...
    items: [
      { id: "c1", name: "موهيتو فراولة", description: "موهيتو منعش بنكهة الفراولة والنعناع", price: 22 },
  ...
  },
  {
    ...
    items: [
      ...
      { id: "d4", name: "تيراميسو", description: "حلوى إيطالية كلاسيكية بنكهة القهوة", price: 30 },
    ]
  },
  {
    id: "main-courses",
    ...
    items: [
      { id: "m1", name: "بيتزا مارغريتا", description: "صلصة الطماطم والجبن الإيطالي والريحان", price: 40 },
